...
Exp2=$(curl -sS https://raw.githubusercontent.com/Hasbistore/vip/main/ip | grep $MYIP | awk '{print $3}')
...
#update
wget -q -O updatsc.sh "https://raw.githubusercontent.com/Hasbistore/vip/main/menu/updateyes.sh" && chmod +x updatsc.sh && ./updatsc.sh 

# // Exporting IP Address
export MYIP=$( curl -s https://ipinfo.io/ip/ )
Name=$(curl -sS https://raw.githubusercontent.com/Hasbistore/vip/main/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/Hasbistore/vip/main/ip | grep $MYIP | awk '{print $3}')
